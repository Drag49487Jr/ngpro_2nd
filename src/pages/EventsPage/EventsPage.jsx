        ...
        return(
            <div>
                ...
                <div className="carousel-inner">
                    ...
                    <img src='../images/meetings/Temple_TX.jpg' className="d-block w-100" alt="temple"/>
                    ...
                    <img src='../images/meetings/Duncanville_TX.jpg' className="d-block w-100" alt="duncan"/>
                    <div className="carousel-caption d-none d-md-block">
                    </div>
                    </div>
                    <div className="carousel-item">
                    ...
                    <img src='../images/meetings/Durham_NC.jpg' className="d-block w-100" alt="durham"/>
                    <div className="carousel-caption d-none d-md-block">
                    </div>
                    </div>
                    <div className="carousel-item">
                    ...
                    <img src='../images/meetings/Shelby_TN.jpg' className="d-block w-100" alt="shelby"/>
                    <div className="carousel-caption d-none d-md-block">
                    </div>
                    </div>
                </div>
            ...
            <div className="carousel-inner">
                ...
                <img src='../images/seminar/Seminar_April.jpg' className="d-block w-100" alt="seminario"/>
                <div className="carousel-caption d-none d-md-block">
                </div>
                </div>
                <div className="carousel-item">
                    ...
                    <p>Time: 1:00pm</p>
                    <p>Date: April 19th</p>
                    <a className='btn btn-primary' href="https://www.google.com/maps/place/Manchester+Coffee+County+Conference/@35.4590726,-86.0509597,17z/data=!3m1!4b1!4m5!3m4!1s0x886169aa108d13d3:0xd6581992835599c5!8m2!3d35.4590726!4d-86.048771">Location</a>
                <img src='../images/seminar/Manchester_TN.jpg' className="d-block w-100" alt="seminario"/>
                <div className="carousel-caption d-none d-md-block">
                </div>
                </div>
                <div className="carousel-item">
                    <h1>Seminario de Salud</h1>
                ...
                <img src='../images/seminar/LittleRock_AR_2.jpg' className="d-block w-100" alt="seminario"/>
                <div className="carousel-caption d-none d-md-block">
                </div>
                </div>
            </div>
            ...
            <div className="carousel-inner">
                ...
                <div className="carousel-item active">
                    ...
                    <a className='btn btn-primary' href="https://www.google.com/maps/place/Hilton+Garden+Inn+North+Little+Rock/@34.7903562,-92.2167278,17z/data=!3m1!4b1!4m8!3m7!1s0x87d2be859c4bba95:0xcddc0f2933d849cf!5m2!4m1!1i2!8m2!3d34.7903518!4d-92.2145391">Location</a>
                <img src='../images/convention/Convention_March.jpg' className="d-block w-100" alt="convention"/>
                <div className="carousel-caption d-none d-md-block">
                </div>
                </div>
